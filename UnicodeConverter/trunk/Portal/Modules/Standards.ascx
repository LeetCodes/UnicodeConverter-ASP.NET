...
<div id="Standards">
    ...
    <div id="StandardsContent">
        <div id="StandardListContainer">
            ...
            <asp:ListBox ID="lstCountries" runat="server" CssClass="StandardList" OnSelectedIndexChanged="lstCountries_SelectedIndexChanged" />
        </div>
        <div id="StandardResult">
            ...
            <div id="StandardResultData">
                <asp:UpdatePanel ID="upResults" runat="server" UpdateMode="Conditional">
                    ...
                    <Triggers>
                        <%--<asp:AsyncPostBackTrigger ControlID="lstCountries" EventName="SelectedIndexChanged" />--%>
                        <asp:PostBackTrigger ControlID="lstCountries" />
                    </Triggers>
                </asp:UpdatePanel>
            </div>
        </div>
